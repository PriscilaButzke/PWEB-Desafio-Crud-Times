...
if(isset($_POST['delete_time'])){
   ...
   $query = "DELETE FROM tbtimes WHERE idtime='$idtime' ";
...
if(isset($_POST['update_time'])){
   ...
   $query = "UPDATE tbtimes SET time='$time', pais='$pais', numtitulos='$numtitulos', treinador='$treinador', coruniforme='$coruniforme' WHERE idtime='$idtime' ";
   $query_run = mysqli_query($con, $query);
  if($query_run) {
